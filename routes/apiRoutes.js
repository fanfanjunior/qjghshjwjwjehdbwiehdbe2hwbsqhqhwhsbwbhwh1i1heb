...
router.get('/downloader/youtube-video-s2', apiRoutesController.downloader_youtube_video_s2);
...
router.get('/downloader/facebook-video-s2', apiRoutesController.downloader_facebook_s2);
router.get('/downloader/twitter', apiRoutesController.downloader_twitter);
router.get('/downloader/twitter-s2', apiRoutesController.downloader_twitter_s2);
router.get('/downloader/instagram', apiRoutesController.downloader_instagram);
router.get('/downloader/instagram-s2', apiRoutesController.downloader_instagram_s2);
router.get('/downloader/tiktok', apiRoutesController.downloader_tiktok);
router.get('/downloader/tiktok-s2', apiRoutesController.downloader_tiktok_s2);
router.get('/downloader/tiktok-s3', apiRoutesController.downloader_tiktok_s3);
...
router.get('/artificial-intelligence/simsimi-s2', apiRoutesController.artificial_intelligence_simsimi_s2);
...
// Islamic
router.get('/islamic/list-surah', apiRoutesController.islamic_list_surah);
router.get('/islamic/surah-detail', apiRoutesController.islamic_surah_detail);
router.get('/islamic/tafsir-surah-detail', apiRoutesController.islamic_tafsir_surah_detail);
router.get('/islamic/shalat-times', apiRoutesController.islamic_shalat_times);

// Tools
router.get('/tools/whois', apiRoutesController.tools_whois);
