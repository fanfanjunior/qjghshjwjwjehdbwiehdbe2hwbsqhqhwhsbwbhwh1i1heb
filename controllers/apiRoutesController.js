...
const simSimi2 = require('node-simsimi');
...
exports.downloader_youtube_video = (req, res) => {
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      daniCodingScraper.downloader.youtube.video(video_url)
        .then(data => {
          if (!data) {
...
exports.downloader_youtube_video_s2 = (req, res) => {
  const {
    video_url,
    api_key
  } = req.query;
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      daniScraper.downloader.youtube_video(video_url)
        .then(response => {
          if (!response.ok) {
...
exports.downloader_youtube_audio = (req, res) => {
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      daniCodingScraper.downloader.youtube.audio(video_url)
        .then(data => {
          if (!data) {
            return res.status(404).json({
              status: "Failed",
...
exports.downloader_youtube_play_video = (req, res) => {
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      daniCodingScraper.downloader.youtube.playvideo(video_title)
        .then(data => {
          if (!data) {
            return res.status(404).json({
              status: "Failed",
...
exports.downloader_youtube_play_audio = (req, res) => {
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      daniCodingScraper.downloader.youtube.playaudio(video_title)
        .then(data => {
          if (!data) {
            return res.status(404).json({
              status: "Failed",
...
exports.downloader_facebook = (req, res) => {
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      daniCodingScraper.downloader.facebook(video_url)
        .then(data => {
          if (!data) {
            return res.status(404).json({
              status: "Failed",
...
exports.downloader_facebook_s2 = (req, res) => {
  const {
    video_url,
    api_key
  } = req.query;
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      daniScraper.downloader.facebook(video_url)
        .then(response => {
          if (!response.ok) {
            throw new Error("Request failed!");
          }
...
exports.downloader_twitter = (req, res) => {
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      daniCodingScraper.downloader.twitter(target_url)
        .then(data => {
          if (!data) {
            return res.status(404).json({
              status: "Failed",
...
exports.downloader_twitter_s2 = (req, res) => {
  const {
    target_url,
    api_key
  } = req.query;
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      daniScraper.downloader.twitter(target_url)
        .then(response => {
          if (!response.ok) {
            throw new Error("Request failed!");
          }
...
exports.downloader_instagram = (req, res) => {
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      daniCodingScraper.downloader.instagram(target_url)
        .then(data => {
          if (!data) {
            return res.status(404).json({
              status: "Failed",
...
exports.downloader_instagram_s2 = (req, res) => {
  const {
    target_url,
    api_key
  } = req.query;
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      daniScraper.downloader.instagram(target_url)
        .then(response => {
          if (!response.ok) {
            throw new Error("Request failed!");
          }
...
exports.downloader_tiktok = (req, res) => {
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      daniCodingScraper.downloader.tiktok(video_url)
        .then(data => {
          if (!data) {
            return res.status(404).json({
              status: "Failed",
...
exports.downloader_tiktok_s2 = (req, res) => {
  const {
    video_url,
    api_key
  } = req.query;
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      daniScraper.downloader.tiktok(video_url)
        .then(response => {
          if (!response.ok) {
            throw new Error("Request failed!");
          }
...
exports.downloader_tiktok_s3 = (req, res) => {
  const {
    video_url,
    api_key
  } = req.query;
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      daniScraper.downloader.tiktok_v2(video_url)
        .then(response => {
          if (!response.ok) {
            throw new Error("Request failed!");
          }
...
exports.downloader_mediafire = (req, res) => {
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      daniCodingScraper.downloader.mediafire(file_url)
        .then(data => {
          if (!data) {
            return res.status(404).json({
              status: "Failed",
...
exports.downloader_sfilemobi = (req, res) => {
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      daniCodingScraper.downloader.sfilemobi(file_url)
        .then(data => {
          if (!data) {
            return res.status(404).json({
              status: "Failed",
...
exports.downloader_soundcloud = (req, res) => {
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      daniCodingScraper.downloader.soundcloud(audio_url)
        .then(data => {
          if (!data) {
            return res.status(404).json({
              status: "Failed",
...
exports.downloader_google_drive = (req, res) => {
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      daniScraper.downloader.google_drive(file_url)
        .then(response => {
          if (!response.ok) {
            throw new Error("Request failed!");
          }
...
exports.searcher_youtube = (req, res) => {
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      daniCodingScraper.search.youtube(video_title)
        .then(data => {
          if (!data) {
            return res.status(404).json({
              status: "Failed",
...
exports.searcher_joox = (req, res) => {
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      daniCodingScraper.search.joox(audio_title)
        .then(data => {
          if (!data) {
            return res.status(404).json({
              status: "Failed",
...
exports.searcher_lyrics = (req, res) => {
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      daniScraper.searcher.lyrics(song_title)
        .then(response => {
          if (!response.ok) {
            throw new Error("Request failed!");
          }
...
exports.searcher_soundcloud = (req, res) => {
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      daniScraper.searcher.soundcloud(song_title)
        .then(response => {
          if (!response.ok) {
            throw new Error("Request failed!");
          }
...
exports.searcher_emoji = (req, res) => {
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      daniScraper.searcher.emoji(emoji_name)
        .then(response => {
          if (!response.ok) {
            throw new Error("Request failed!");
          }
...
exports.searcher_stack_overflow = (req, res) => {
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      daniScraper.searcher.stackoverflow(post_title)
        .then(response => {
          if (!response.ok) {
            throw new Error("Request failed!");
          }
...
exports.searcher_sfilemobi = (req, res) => {
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      daniCodingScraper.search.sfilemobi(file_name)
        .then(data => {
          if (!data) {
            return res.status(404).json({
              status: "Failed",
...
exports.searcher_happymod = (req, res) => {
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      daniCodingScraper.search.happymod(app_name)
        .then(data => {
          if (!data) {
            return res.status(404).json({
              status: "Failed",
...
exports.searcher_whatsapp_group = (req, res) => {
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      daniCodingScraper.search.groupwa(group_name)
        .then(data => {
          if (!data) {
            return res.status(404).json({
              status: "Failed",
...
exports.searcher_sticker = (req, res) => {
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      daniCodingScraper.search.sticker(sticker_name)
        .then(data => {
          if (!data) {
            return res.status(404).json({
              status: "Failed",
...
exports.searcher_wallpaper = (req, res) => {
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      daniCodingScraper.search.wallpaper(wallpaper_name)
        .then(data => {
          if (!data) {
            return res.status(404).json({
              status: "Failed",
...
exports.searcher_ringtone = (req, res) => {
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      daniCodingScraper.search.ringtone(ringtone_name)
        .then(data => {
          if (!data) {
            return res.status(404).json({
              status: "Failed",
...
exports.searcher_pinterest = (req, res) => {
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      daniCodingScraper.search.pinterest(pint_search)
        .then(data => {
          if (!data) {
            return res.status(404).json({
              status: "Failed",
...
exports.searcher_wikimedia = (req, res) => {
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      daniCodingScraper.search.wikimedia(wiki_search)
        .then(data => {
          if (!data) {
            return res.status(404).json({
              status: "Failed",
...
exports.stalker_tiktok = (req, res) => {
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      daniScraper.stalker.tiktok(username)
        .then(response => {
          if (!response.ok) {
            throw new Error("Request failed!");
          }
...
exports.stalker_github_user = (req, res) => {
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      daniScraper.stalker.github_user(username)
        .then(response => {
          if (!response.ok) {
            throw new Error("Request failed!");
          }
...
exports.stalker_github_repo = (req, res) => {
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      daniScraper.stalker.github_repo(username, repo_name)
        .then(response => {
          if (!response.ok) {
            throw new Error("Request failed!");
          }
...
exports.stalker_github_show_all_repo = (req, res) => {
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      daniScraper.stalker.github_show_all_repo(username)
        .then(response => {
          if (!response.ok) {
            throw new Error("Request failed!");
          }
...
exports.stalker_npmjs_package = (req, res) => {
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      daniScraper.stalker.npmjs_package(package_name)
        .then(response => {
          if (!response.ok) {
            throw new Error("Request failed!");
          }
...
exports.stalker_ip = (req, res) => {
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      daniScraper.stalker.ip(ip_address)
        .then(response => {
          if (!response.ok) {
            throw new Error("Request failed!");
          }
...
exports.artificial_intelligence_openai_chatgpt_3 = (req, res) => {
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      daniScraper.artificial_intelligence.chatgpt_3(question)
        .then(response => {
          if (!response.ok) {
            throw new Error("Request failed!");
          }
...
exports.artificial_intelligence_openai_chatgpt_35 = (req, res) => {
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      daniScraper.artificial_intelligence.chatgpt_35(question)
        .then(response => {
          if (!response.ok) {
            throw new Error("Request failed!");
          }
...
exports.artificial_intelligence_chatty_ai = (req, res) => {
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      daniScraper.artificial_intelligence.chatty_ai(question)
        .then(response => {
          if (!response.ok) {
            throw new Error("Request failed!");
          }
...
exports.artificial_intelligence_google_bard = (req, res) => {
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      daniScraper.artificial_intelligence.bard(question)
        .then(response => {
          if (!response.ok) {
            throw new Error("Request failed!");
          }
...
exports.artificial_intelligence_simsimi_s2= (req, res) => {
  const {
    question,
    language,
    api_key
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      db.query('INSERT INTO request_logs (api_key, date, daily_requests, total_requests) VALUES (?, ?, 1, 1) ON DUPLICATE KEY UPDATE daily_requests = daily_requests + 1, total_requests = total_requests + 1', [api_key, currentTime], (err) => {
        ...
        daniScraper.artificial_intelligence.midjourney(text)
          .then((response) => {
            if (!response.ok) {
      ...
      db.query('INSERT INTO request_logs (api_key, date, daily_requests, total_requests) VALUES (?, ?, 1, 1) ON DUPLICATE KEY UPDATE daily_requests = daily_requests + 1, total_requests = total_requests + 1', [api_key, currentTime], (err) => {
        ...
        stableDiffusion.generate(prompt, async (result) => {
          try {
            ...
            res.status(200).sendFile(fileArray[0], (err) => {
              if (err) {
                console.error(err);
                return res.status(500).json({
                  status: "Failed",
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      db.query('INSERT INTO request_logs (api_key, date, daily_requests, total_requests) VALUES (?, ?, 1, 1) ON DUPLICATE KEY UPDATE daily_requests = daily_requests + 1, total_requests = total_requests + 1', [api_key, currentTime], (err) => {
        ...
        daniScraper.artificial_intelligence.anime_filter(image_url)
          .then((response) => {
            if (!response.ok) {
              throw new Error('Network response was not ok');
            }
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      db.query('INSERT INTO request_logs (api_key, date, daily_requests, total_requests) VALUES (?, ?, 1, 1) ON DUPLICATE KEY UPDATE daily_requests = daily_requests + 1, total_requests = total_requests + 1', [api_key, currentTime], (err) => {
        ...
        daniScraper.maker.enhance(image_url)
          .then((response) => {
            if (!response.ok) {
              throw new Error('Network response was not ok');
            }
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      db.query('INSERT INTO request_logs (api_key, date, daily_requests, total_requests) VALUES (?, ?, 1, 1) ON DUPLICATE KEY UPDATE daily_requests = daily_requests + 1, total_requests = total_requests + 1', [api_key, currentTime], (err) => {
        ...
        daniScraper.maker.beautiful(image_url)
          .then((response) => {
            if (!response.ok) {
              throw new Error('Network response was not ok');
            }
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      db.query('INSERT INTO request_logs (api_key, date, daily_requests, total_requests) VALUES (?, ?, 1, 1) ON DUPLICATE KEY UPDATE daily_requests = daily_requests + 1, total_requests = total_requests + 1', [api_key, currentTime], (err) => {
        ...
        daniScraper.maker.blur(image_url)
          .then((response) => {
            if (!response.ok) {
              throw new Error('Network response was not ok');
            }
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      db.query('INSERT INTO request_logs (api_key, date, daily_requests, total_requests) VALUES (?, ?, 1, 1) ON DUPLICATE KEY UPDATE daily_requests = daily_requests + 1, total_requests = total_requests + 1', [api_key, currentTime], (err) => {
        ...
        daniScraper.maker.invert(image_url)
          .then((response) => {
            if (!response.ok) {
              throw new Error('Network response was not ok');
            }
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      db.query('INSERT INTO request_logs (api_key, date, daily_requests, total_requests) VALUES (?, ?, 1, 1) ON DUPLICATE KEY UPDATE daily_requests = daily_requests + 1, total_requests = total_requests + 1', [api_key, currentTime], (err) => {
        ...
        daniScraper.maker.rainbow(image_url)
          .then((response) => {
            if (!response.ok) {
              throw new Error('Network response was not ok');
            }
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      db.query('INSERT INTO request_logs (api_key, date, daily_requests, total_requests) VALUES (?, ?, 1, 1) ON DUPLICATE KEY UPDATE daily_requests = daily_requests + 1, total_requests = total_requests + 1', [api_key, currentTime], (err) => {
        ...
        daniScraper.maker.trigger(image_url)
          .then((response) => {
            if (!response.ok) {
              throw new Error('Network response was not ok');
            }
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      db.query('INSERT INTO request_logs (api_key, date, daily_requests, total_requests) VALUES (?, ?, 1, 1) ON DUPLICATE KEY UPDATE daily_requests = daily_requests + 1, total_requests = total_requests + 1', [api_key, currentTime], (err) => {
        ...
        daniScraper.maker.wanted(image_url)
          .then((response) => {
            if (!response.ok) {
              throw new Error('Network response was not ok');
            }
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      db.query('INSERT INTO request_logs (api_key, date, daily_requests, total_requests) VALUES (?, ?, 1, 1) ON DUPLICATE KEY UPDATE daily_requests = daily_requests + 1, total_requests = total_requests + 1', [api_key, currentTime], (err) => {
        ...
        daniScraper.maker.wasted(image_url)
          .then((response) => {
            if (!response.ok) {
              throw new Error('Network response was not ok');
            }
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      db.query('INSERT INTO request_logs (api_key, date, daily_requests, total_requests) VALUES (?, ?, 1, 1) ON DUPLICATE KEY UPDATE daily_requests = daily_requests + 1, total_requests = total_requests + 1', [api_key, currentTime], (err) => {
        ...
        daniScraper.maker.darkness(image_url, volume)
          .then((response) => {
            if (!response.ok) {
              throw new Error('Network response was not ok');
            }
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      db.query('INSERT INTO request_logs (api_key, date, daily_requests, total_requests) VALUES (?, ?, 1, 1) ON DUPLICATE KEY UPDATE daily_requests = daily_requests + 1, total_requests = total_requests + 1', [api_key, currentTime], (err) => {
        ...
        daniScraper.maker.pixelate(image_url, volume)
          .then((response) => {
            if (!response.ok) {
              throw new Error('Network response was not ok');
            }
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      db.query('INSERT INTO request_logs (api_key, date, daily_requests, total_requests) VALUES (?, ?, 1, 1) ON DUPLICATE KEY UPDATE daily_requests = daily_requests + 1, total_requests = total_requests + 1', [api_key, currentTime], (err) => {
        ...
        try {
          const data = daniScraper.random_image.anime_sfw
            .akira();
          return res.status(200).json({
            status: "Success",
            code: 200,
    ...
    if (result.length > 0) {
      ...
      if (user.account_type !== "Premium" && user.account_type !== "Enterprise") {
        ...
        db.query('INSERT INTO request_logs (api_key, date, daily_requests, total_requests) VALUES (?, ?, 1, 1) ON DUPLICATE KEY UPDATE daily_requests = daily_requests + 1, total_requests = total_requests + 1', [api_key, currentTime], (err) => {
          ...
          try {
            const data = daniScraper.random_image.anime_nsfw
              .ahegao();
            return res.status(200).json({
            status: "Success",
            code: 200,
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      db.query('INSERT INTO request_logs (api_key, date, daily_requests, total_requests) VALUES (?, ?, 1, 1) ON DUPLICATE KEY UPDATE daily_requests = daily_requests + 1, total_requests = total_requests + 1', [api_key, currentTime], (err) => {
        ...
        daniScraper.converter.text_to_image(text)
          .then((response) => {
            if (!response.ok) {
              throw new Error('Network response was not ok');
            }
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      db.query('INSERT INTO request_logs (api_key, date, daily_requests, total_requests) VALUES (?, ?, 1, 1) ON DUPLICATE KEY UPDATE daily_requests = daily_requests + 1, total_requests = total_requests + 1', [api_key, currentTime], (err) => {
        ...
        daniScraper.converter.text_to_gif(text)
          .then((response) => {
            if (!response.ok) {
              throw new Error('Network response was not ok');
            }
...
// Islamic
exports.islamic_list_surah = (req, res) => {
  const {
    api_key
  } = req.query;
...
exports.islamic_surah_detail = (req, res) => {
  const {
    number,
    api_key
  } = req.query;
  ...
  if (!number || !api_key) {
    return res.status(400).json({
      status: "Failed",
      code: 400,
      message: "Number or API key parameters not found!"
    });
  }
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      const API = (number) => {
        return fetch('https://equran.id/api/v2/surat/' + number);
      };
...
exports.islamic_tafsir_surah_detail = (req, res) => {
  const {
    number,
    api_key
  } = req.query;
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      const API = (number) => {
        return fetch('https://equran.id/api/v2/tafsir/' + number);
      };
...
exports.islamic_shalat_times = (req, res) => {
  const {
    city_code,
    date,
    api_key
  ...
  if (!city_code || !date || !api_key) {
    return res.status(400).json({
      status: "Failed",
      code: 400,
      message: "City code (https://api.banghasan.com/sholat/format/json/kota), Date or API key parameters not found!"
    });
  }
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      fetch('https://api.banghasan.com/sholat/format/json/jadwal/kota/' + city_code + '/tanggal/' + date)
        .then(response => response.json())
        .then(data => {
          if (!data) {
            return res.status(404).json({
...
exports.tools_whois = (req, res) => {
  ...
  if (!domain || !api_key) {
    return res.status(400).json({
      status: "Failed",
      code: 400,
      message: "Domain or API key parameters not found!"
    });
  }
...
exports.tools_get_temp_mail = (req, res) => {
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      daniScraper.tools.get_temp_mail()
        .then(response => {
          if (!response.ok) {
            throw new Error("Request failed!");
          }
...
exports.tools_get_temp_mail_inbox = (req, res) => {
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      daniScraper.tools.get_temp_mail_inbox(id)
        .then(response => {
          if (!response.ok) {
            throw new Error("Request failed!");
          }
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      db.query('INSERT INTO request_logs (api_key, date, daily_requests, total_requests) VALUES (?, ?, 1, 1) ON DUPLICATE KEY UPDATE daily_requests = daily_requests + 1, total_requests = total_requests + 1', [api_key, currentTime], (err) => {
        ...
        daniScraper.tools.screenshot_website(target_url, device).then((data) => {
            res.set({
              'Content-Type': 'image/png'
            })
            res.status(200).send(data)
...
exports.tools_style_text = (req, res) => {
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      daniScraper.tools.style_text(text)
        .then(data => {
          if (!data) {
            return res.status(404).json({
              status: "Failed",
...
exports.tools_base32_encode = (req, res) => {
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      const encodedText = daniScraper.tools.base32_encode(text);
...
exports.tools_base32_decode = (req, res) => {
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      const decodedText = daniScraper.tools.base32_decode(text);
...
exports.tools_base64_encode = (req, res) => {
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      const encodedText = daniScraper.tools.base64_encode(text);
...
exports.tools_base64_decode = (req, res) => {
  ...
  db.query('SELECT * FROM users WHERE api_key = ?', [api_key], (err, result) => {
    ...
    if (result.length > 0) {
      ...
      const decodedText = daniScraper.tools.base64_decode(text);
